        ...
        <div class="row">
            <div class="col-md-4">                
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('teacher/feetype') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                                ...
                                <div class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        if (!empty($arrvalue)) {
                                            ?>
                                            <div class="print">
                                                <b><?php echo $this->lang->line('fees_category'); ?>: </b> <span class="ftype"></span>
                                            </div>
                                                    ...
                                                    foreach ($arrvalue as $arkey => $arvalue) {
                                                        ...
                                                        <tr> 
                                                            ...
                                                            <td  class="mailbox-date pull-right no-print">
                                                                <a href="<?php echo base_url(); ?>teacher/feetype/edit/<?php echo $arkey; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <a href="<?php echo base_url(); ?>teacher/feetype/delete/<?php echo $arkey; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
