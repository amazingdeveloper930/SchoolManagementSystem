        ...
        <div class="row">
            <div class="col-md-4">               
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('teacher/route/edit/' . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus="" id="route_title" name="route_title" placeholder="route_title" type="text" class="form-control"  value="<?php echo set_value('route_title', $editroute['route_title']); ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input id="fare" name="fare" placeholder="fare" type="text" class="form-control"  value="<?php echo set_value('fare', $editroute['fare']); ?>" />
