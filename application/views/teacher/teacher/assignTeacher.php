<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="box box-primary">           
            ...
            <form  class="assign_teacher_form" action="<?php echo base_url(); ?>teacher/teacher/getSubjectTeachers" method="post" enctype="multipart/form-data">
                <div class="box-body">
        ...
        <div class="box box-info" id="box_display" style="display:none">
            ...
            <form action="<?php echo base_url() ?>teacher/teacher/assignteacher" method="POST" id="formSubjectTeacher">
                <?php echo $this->customlib->getCSRF(); ?>
                <br/>
