        ...
        <body>
            ...
            <main>
                <div id="details" class="clearfix">                   
                    ...
                    <div  style="text-align: center;"><b>  <th><?php echo $this->lang->line('class'); ?></th>: <?php echo $class[0]['class']; ?>   <?php echo $this->lang->line('section'); ?> : <?php echo $class[0]['section']; ?></b></div>
