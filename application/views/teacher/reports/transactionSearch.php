    ...
    <body>
        ...
        <main>
            ...
            <div id="details" class="clearfix">              
                ...
                <h6 class="text text-left"><b><?php echo $this->lang->line('fees_collection_details'); ?></b></h6><hr/>
                <table class="">
                    <thead>
                        <tr>
                            ...
                            <th class="text text-right"><?php echo $this->lang->line('fee'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr ><th colspan="4" class="text-right"><?php echo $this->lang->line('grand_total'); ?> </th>
                            <th class="text text-right"><?php echo number_format($amount, 2, '.', ''); ?></th>
                            <th class="text text-right"><?php echo number_format($discount, 2, '.', ''); ?></th>
                            <th class="text text-right"><?php echo number_format($fine, 2, '.', ''); ?></th>
                            <th class="text text-right"><?php echo number_format($total, 2, '.', ''); ?></th></tr>
                    </tbody>
                </table>
