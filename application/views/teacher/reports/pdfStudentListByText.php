        ...
        <body>
            ...
            <main>
                <div id="details" class="clearfix">
                    <h2 style="text-align: center;margin: 4px;"><?php echo form_error('student_record'); ?></h2>
                    <div  style="text-align: center;"><?php echo form_error('date'); ?>: <?php echo date($this->customlib->getSchoolDateFormat()); ?></div> 
                </div>
                <div id="details" class="clearfix">                 
                    <table>
                        <thead>
