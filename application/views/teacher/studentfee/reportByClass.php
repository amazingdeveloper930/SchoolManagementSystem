        ...
        <div class="row">  
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('teacher/studentfee/reportbyclass') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <button type="reset" class="btn btn-default"><?php echo $this->lang->line('reset'); ?></button>  </div>
                    </form>
                </div>
                </section>
                <?php
                        ...
                        foreach ($student_fees_array as $key => $student_array) {
                            ...
                            <section class="invoice" style="margin: 10px 15px;">                              
                                ...
                                <div class="row no-print">
                                    <div class="col-xs-12">
                                        <a href="<?php echo base_url(); ?>teacher/teacher/studentfee/addfee/<?php echo $st_detail['id']; ?>" class="btn btn-primary pull-right"><i class="fa fa-credit-card"></i> <?php echo $this->lang->line('collect_fees'); ?></button>
                                            <a href="<?php echo base_url(); ?>teacher/report/pdfStudentFeeRecord/<?php echo $class_id; ?>/<?php echo $section_id ?>/<?php echo $st_detail['id']; ?>" class="btn bg-orange pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> <?php echo $this->lang->line('download_pdf'); ?></a>
                                    </div>
                                </div>
                            </section>
                            <?php
