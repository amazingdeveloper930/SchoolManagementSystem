        ...
        <div class="row">          
            <div class="col-md-4">               
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('teacher/classes/addsection/' . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                                        ...
                                        foreach ($classSectionlist as $classSection) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <a href="<?php echo base_url(); ?>teacher/classes/deletesection/<?php echo $classSection['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');" >
