        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('teacher/classes/edit/' . $id) ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                                        ...
                                        foreach ($vehroutelist as $vehroute) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if (!empty($vehicles)) {
                                                        ...
                                                        foreach ($vehicles as $key => $value) {
                                                            ...
                                                            echo "<div><b>" . $value->section . "</b></div>";
                                                        }
                                                    }
                                                    ?>
                                                ...
                                                <td class="mailbox-date pull-right"">
                                                    <a href="<?php echo base_url(); ?>teacher/classes/edit/<?php echo $vehroute->id; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a href="<?php echo base_url(); ?>teacher/classes/delete/<?php echo $vehroute->id; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
