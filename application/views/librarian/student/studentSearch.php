                                                ...
                                                <tr class="<?php echo $clsactive; ?>">
                                                    ...
                                                    <td class="text text-right">
                                                        ...
                                                        if ($student['libarary_member_id'] == 0) {
                                                            ...
                                                            ?>
                                                            <button type="button" class="btn btn-default btn-xs surrender-student" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait.." data-memberid="<?php echo $member_id; ?>" data-toggle="tooltip" title="<?php echo $this->lang->line('surrender_membership'); ?>"><i class="fa fa-mail-reply"></i></button>
