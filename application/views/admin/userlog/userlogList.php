            ...
            <div class="col-md-12">            
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                        ...
                        <li><a href="#tab_librarian" data-toggle="tab"><?php echo $this->lang->line('librarians'); ?></a></li>
                        <li><a href="#tab_teacher" data-toggle="tab"><?php echo $this->lang->line('teachers'); ?></a></li>
                        <li><a href="#tab_accountant" data-toggle="tab"><?php echo $this->lang->line('accountants'); ?></a></li>                        
                        <li><a href="#tab_admin" data-toggle="tab">Admin</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <!-- /.tab-pane -->
                        <div class="tab-pane table-responsive" id="tab_admin">
                            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('users'); ?></th>
                                ...
                                <tbody>
                                    <?php
                                    if (!empty($userlogAdminList)) {
                                        $count = 1;
                                        foreach ($userlogAdminList as $userlogAdmin) {
                                            ?>
                                            <tr>
                        ...
                        <div class="tab-pane table-responsive" id="tab_accountant">
                            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                    if (!empty($userlogAccountantList)) {
                                        $count = 1;
                                        foreach ($userlogAccountantList as $userlogAccountant) {
                                            ?>
                                            <tr>
                                                <td><?php echo $userlogAccountant['user']; ?></td>                                                
                                                <td><?php echo ucfirst($userlogAccountant['role']); ?></td>
                                                <td><?php echo $userlogAccountant['ipaddress']; ?></td>
                                                <td>
                                                 
                                                    <?php
                                               $date_time=strtotime($userlogAccountant['login_datetime']);
                                               $date =date('Y-m-d',$date_time);
                                               $time= date('H:i:s',$date_time);
                                                echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($date))." ".$time;
                                                ?>
                                                ...
                                                <td><?php echo $userlogAccountant['user_agent']; ?></td>  
                                            </tr>
                                            <?php
                                            $count++;
                                        }
                        ...
                        <div class="tab-pane table-responsive" id="tab_teacher">
                            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                    if (!empty($userlogTeacherList)) {
                                        $count = 1;
                                        foreach ($userlogTeacherList as $userlogTeacher) {
                                            ?>
                                            <tr>
                                                <td><?php echo $userlogTeacher['user']; ?></td>                                                
                                                <td><?php echo ucfirst($userlogTeacher['role']); ?></td>
                                                <td><?php echo $userlogTeacher['ipaddress']; ?></td>
                                                <td>
                                                    
                                                    <?php
                                               $date_time=strtotime($userlogTeacher['login_datetime']);
                                               $date =date('Y-m-d',$date_time);
                                               $time= date('H:i:s',$date_time);
                                                echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($date))." ".$time;
                                                ?>
                                                ...
                                                <td><?php echo $userlogTeacher['user_agent']; ?></td>  
                                            </tr>
                                            <?php
                                            $count++;
                                        }
                        ...
                        <div class="tab-pane table-responsive" id="tab_librarian">
                            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                    if (!empty($userlogLibrarianList)) {
                                        $count = 1;
                                        foreach ($userlogLibrarianList as $userlogLibrarian) {
                                            ?>
                                            <tr>
                                                <td><?php echo $userlogLibrarian['user']; ?></td>                                                
                                                <td><?php echo ucfirst($userlogLibrarian['role']); ?></td>
                                                <td><?php echo $userlogLibrarian['ipaddress']; ?></td>
                                                <td>
                                                    
                                                        <?php
                                               $date_time=strtotime($userlogLibrarian['login_datetime']);
                                               $date =date('Y-m-d',$date_time);
                                               $time= date('H:i:s',$date_time);
                                                echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($date))." ".$time;
                                                ?>
                                                ...
                                                <td><?php echo $userlogLibrarian['user_agent']; ?></td>  
                                            </tr>
                                            <?php
                                            $count++;
                                        }
