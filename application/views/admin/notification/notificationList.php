                                    ...
                                    <div class="panel box box-primary">
                                        <div class="box-header with-border">
                                            ...
                                            <div class="pull-right">
                                                ...
                                                &nbsp;                                              <a href="<?php echo base_url() ?>admin/notification/delete/<?php echo $notification['id'] ?>" class="" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" data-original-title="<?php echo $this->lang->line('add'); ?>">
