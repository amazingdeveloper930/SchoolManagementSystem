                                    ...
                                    if (empty($itemissueList)) {
                                        ...
                                        foreach ($itemissueList as $item) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php echo $item['issue_to'] . " (" . ucfirst($item['issue_type']) . ")"; ?>
                                                </td>
                                                ...
                                                <td class="mailbox-date pull-right"">
                                                    ...
                                                    <a href="<?php echo base_url(); ?>admin/issueitem/delete/<?php echo $item['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
