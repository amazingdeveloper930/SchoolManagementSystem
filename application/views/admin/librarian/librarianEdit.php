                                        ...
                                        foreach ($librarianlist as $librarian) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right"">
                                                    ...
                                                    <a href="<?php echo base_url(); ?>admin/librarian/delete/<?php echo $librarian['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?')";>
