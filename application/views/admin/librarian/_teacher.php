...
<div class="box box-primary">
    <div class="box-body box-profile">
        ...
        <ul class="list-group list-group-unbordered">
            ...
            <li class="list-group-item">
                <b><?php echo $this->lang->line('gender'); ?></b> <a class="pull-right text-aqua"><?php echo $memberList->sex ?></a>
            </li>
            <li class="list-group-item">
                <b><?php echo $this->lang->line('phone'); ?></b> <a class="pull-right text-aqua"><?php echo $memberList->phone ?></a>
            </li>
