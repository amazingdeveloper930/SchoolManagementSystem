...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-credit-card"></i> <?php echo $this->lang->line('income'); ?></h1>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form  action="<?php echo site_url('accountant/incomehead/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">                            
                                        ...
                                        foreach ($categorylist as $category) {
                                            ...
                                            <tr>                                               
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    <a href="<?php echo base_url(); ?>accountant/incomehead/edit/<?php echo $category['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a href="<?php echo base_url(); ?>accountant/incomehead/delete/<?php echo $category['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
