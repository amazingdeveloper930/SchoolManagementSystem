        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    ...
                    <!-- <?php //echo form_open_multipart('accountant/income/index');  ?>  -->
                    <form id="form1" action="<?php echo base_url() ?>accountant/income"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                                    ...
                                    if (empty($incomelist)) {
                                        ...
                                        foreach ($incomelist as $income) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name"><?php echo ($currency_symbol . $income['amount']); ?>
                                                </td>
