...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-credit-card"></i> <?php echo $this->lang->line('search_income'); ?></h1>
    </section>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('accountant/income/incomeSearch') ?>" method="post" class="">
                                    ...
                                    <form role="form" action="<?php echo site_url('accountant/income/incomeSearch') ?>" method="post" class="">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo set_value('search_text', ""); ?>" name="search_text"  class="form-control" placeholder="Search by Income">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
