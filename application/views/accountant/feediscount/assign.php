    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="">
                            ...
                            <form role="form" action="<?php echo site_url('accountant/feediscount/assign/' . $id) ?>" method="post" class="form-horizontal">
                ...
                <form method="post" action="<?php echo site_url('accountant/feediscount/studentdiscount') ?>" id="assign_form">
