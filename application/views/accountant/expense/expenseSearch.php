                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('accountant/expense/expenseSearch') ?>" method="post" class="">
                                    ...
                                    <form role="form" action="<?php echo site_url('accountant/expense/expenseSearch') ?>" method="post" class="">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" autofocus="" value="<?php echo set_value('search_text', ""); ?>" name="search_text"  class="form-control" placeholder="Search by Expense">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                ...
                                <tbody>
                                    ...
                                    foreach ($resultList as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><?php echo ($currency_symbol . $value['amount']); ?>  </td>
                                        </tr>
                                        <?php
                                        $count++;
                                    }
                                    ...
                                    <tr  class="total-bg">
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td class="text-right text-bold"><?php echo $this->lang->line('grand_total'); ?> : <?php echo ($currency_symbol . number_format($grand_total, 2, '.', '')); ?>
