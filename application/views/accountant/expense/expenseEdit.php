        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url("accountant/expense/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" enctype="multipart/form-data"  accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            ?>">
                                ...
                                <select http://192.168.2.81/ss3/teacher/content/assignment id="exp_head_id" name="exp_head_id" class="form-control" >
