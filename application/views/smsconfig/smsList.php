                                    ...
                                    <div class="row">
                                        <div class="col-md-12 minheight170">
                                            <div class="col-md-7">
                                                ...
                                                ?>
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('auth_Key'); ?></label>
                                                    <div class="col-sm-7">
                                        ...
                                        <div class="col-md-12 minheight170">
                                            <div class="col-md-7">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="smscountrypassword" value="<?php echo $smscountry_result->password; ?>">
                                        ...
                                        <div class="col-md-12 minheight170">
                                            <div class="col-md-7">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="text_localpassword" value="<?php echo $text_local_result->password; ?>">
