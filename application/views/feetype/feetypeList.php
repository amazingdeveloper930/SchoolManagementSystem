                                                    ...
                                                    foreach ($arrvalue as $arkey => $arvalue) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td  class="mailbox-date pull-right no-print">
                                                                ...
                                                                <a href="<?php echo base_url(); ?>feetype/delete/<?php echo $arkey; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
