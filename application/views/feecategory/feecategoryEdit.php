                                        ...
                                        foreach ($feecategorylist as $feecategory) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right"">
                                                    ...
                                                    <a href="<?php echo base_url(); ?>feecategory/delete/<?php echo $feecategory['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
