...
class studentfee extends CI_Controller {
    ...
    function index() {
        ...
        $this->load->view('teacher/studentfee/studentfeeSearch', $data);
    ...
    function feesearch() {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/studentfee/studentSearchFee', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
    ...
    function reportbyname() {
        ...
        if ($this->input->server('REQUEST_METHOD') == "GET") {
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/studentfee/reportByName', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
    ...
    function reportbyclass() {
        ...
        if ($this->input->server('REQUEST_METHOD') == "GET") {
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/studentfee/reportByClass', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
    ...
    function view($id) {
        ...
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/studentfee/studentfeeShow', $data);
        $this->load->view('layout/teacher/footer', $data);
    }
    ...
    function addfee($id) {
        ...
        $data['categorylist'] = $category;
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/studentfee/studentAddfee', $data);
        $this->load->view('layout/teacher/footer', $data);
    }
    ...
    function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/studentfee/studentfeeCreate', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
            $data = array(
            ...
            redirect('teacher/studentfee/index');
        }
    }
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/studentfee/studentfeeEdit', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
            $data = array(
                'id' => $id,
    ...
    function printFeesByName() {
        ...
        if (!empty($trans_array)) {
            ...
            $transport_record_array = $this->studenttransportfee_model->getTransportFeeByIDs($trans_array);
        }
        $data['monthly_record'] = $monthly_record_array;
        $data['transport_record'] = $transport_record_array;
        $this->load->view('teacher/print/printFeesByName', $data);
    }
    ...
    function searchpayment() {
        ...
        if ($this->input->server('REQUEST_METHOD') == "POST") {
            $search = $this->input->post('search');
            if ($search == "search_filter") {
                $data['exp_title'] = 'Payment ID Details';
            ...
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/studentfee/searchpayment', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/studentfee/searchpayment', $data);
