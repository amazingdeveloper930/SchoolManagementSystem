...
class feemaster extends CI_Controller {
    ...
    function index() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($result) {
                ...
                redirect('teacher/feemaster/index');
            } else {
        ...
        $this->load->view('teacher/feemaster/feemasterList', $data);
    ...
    function view($id) {
        ...
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/feemaster/feemasterShow', $data);
        $this->load->view('layout/teacher/footer', $data);
    }
    ...
    function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/feemaster/feemasterCreate', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
            $data = array(
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/feemaster/feemasterEdit', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
            $data = array(
                'id' => $id,
