...
class Feediscount extends CI_Controller {
    ...
    function delete($id) {
        ...
        redirect('accountant/feediscount/index');
    }

    function index() {
        $this->session->set_userdata('top_menu', 'Fees Collection');
        $this->session->set_userdata('sub_menu', 'accountant/feediscount');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('accountant/feediscount/feediscountList', $data);
            ...
            redirect('accountant/feediscount');
        }
    }
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/accountant/header', $data);
            $this->load->view('accountant/feediscount/feediscountEdit', $data);
            $this->load->view('layout/accountant/footer', $data);
        } else {
            $data = array(
                'id' => $id,
    ...
    function assign($id) {
        ...
        $this->load->view('layout/accountant/header', $data);
        $this->load->view('accountant/feediscount/assign', $data);
        $this->load->view('layout/accountant/footer', $data);
    }
